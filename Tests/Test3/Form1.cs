...
namespace Test3
{
    public partial class Form1 : Form
    {
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            ...
            //-----------------
            string tsc_esprCode = File.ReadAllText("../../Samples/js_tools/tsc2_1/tsc_espr.js");
            StringBuilder stbuilder = new StringBuilder();
        ...
        private void button12_Click(object sender, EventArgs e)
        {
            ...
            using (JsContext ctx = engine.CreateContext(new MyJsTypeDefinitionBuilder()))
            {
                ...
                var my_expr_ext = new Espresso.TypeScript.EspressoHostForTsc_25();
                ...
                string testsrc = @"(function(){
                        ...
                        my_expr_ext.ConsoleLog(json_result);
                        return json_result;
                    })()";
                stbuilder.Append(testsrc);
                ...
                stwatch.Stop();
                //
                Espresso.TypeScript.TsFromJson tsFromJson = new Espresso.TypeScript.TsFromJson();
